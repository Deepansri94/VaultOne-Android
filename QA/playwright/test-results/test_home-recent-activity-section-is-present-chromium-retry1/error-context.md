...
- Name: test_home.spec.ts >> recent activity section is present
- Location: tests\test_home.spec.ts:44:5
...
Locator: locator('#recentActivity, #activityList, .recent-activity')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#recentActivity, #activityList, .recent-activity')
